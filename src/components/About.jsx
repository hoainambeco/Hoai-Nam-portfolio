...
export default function About({ goTo }) {
  ...
  return (
    <section
      ...
      style={{
        background:
          'linear-gradient(160deg, #050520 0%, #0B0830 35%, #0D1540 70%, #080C28 100%)',
      }}
    >
      <Stars count={90} />
      ...
      <div
        ...
        style={{
          ...
          left: '-8%',
          background:
            'radial-gradient(circle, rgba(0,80,200,0.2) 0%, transparent 65%)',
          filter: 'blur(30px)',
        }}
      />
      <div
        ...
        style={{
          ...
          right: '-6%',
          background:
            'radial-gradient(circle, rgba(255,159,67,0.12) 0%, transparent 65%)',
          filter: 'blur(35px)',
        }}
      />
      ...
      >
        <img
          ...
          style={{
            width: '100%',
            filter: 'drop-shadow(0 0 60px rgba(0,130,255,0.5))',
          }}
        />
      </div>
        ...
        <div style={{ width: '100%', maxWidth: 680 }}>
                ...
                >
                  <span
                    style={{
                      ...
                      boxShadow: '0 0 6px rgba(80,255,150,0.8)',
                    }}
                  />
                  OPEN TO WORK
                </span>
          ...
          <div
            style={{
              height: 1,
              background:
                'linear-gradient(to right, transparent, rgba(0,245,255,0.3), transparent)',
              marginBottom: 24,
            }}
          />
